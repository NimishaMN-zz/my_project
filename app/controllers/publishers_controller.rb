class PublishersController < ApplicationController
  ...
  def index
    ...
    @publishers = Publisher.save_data_from_api
    logger.debug "gfgfgfgf #{@publishers.inspect}"

    @publishers1 = Publisher.all
  end
  ...
  def show
    ...
    # publisher = JSON.parse(data)
    # publisher.each {|line| puts line['publisher']['id']}
  end
